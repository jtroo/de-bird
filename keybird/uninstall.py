...
def confirm_uninstall():
    ...
    print("   - /opt/de-bird/keyboard_profiles.json")
    print("   - /opt/de-bird/keyboard_mappings.json")
    print("   - /opt/de-bird/trackpad_calibrations.json")
    print()
...
def main():
    ...
    print("      rm /opt/de-bird/keyboard_mappings.json")
    print("      rm /opt/de-bird/trackpad_calibrations.json")
    print()
